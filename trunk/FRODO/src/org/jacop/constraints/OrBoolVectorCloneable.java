 ...
 */
public class OrBoolVectorCloneable extends OrBoolVector implements ConstraintCloneableInterface<OrBoolVectorCloneable> {

	/** Constructor
	 * @param vars 		the list of variables
	 * @param result 	the result variable
	 */
	public OrBoolVectorCloneable(IntVarCloneable[] vars, IntVarCloneable result) {
		super(vars, result);
	}
	 ...
	 * @param result 	the result variable
	 */
	public OrBoolVectorCloneable(ArrayList<? extends IntVarCloneable> vars, IntVarCloneable result) {
		super(vars, result);
	}

	/** @see ConstraintCloneableInterface#cloneInto(StoreCloneable) */
	@Override
	public OrBoolVectorCloneable cloneInto(StoreCloneable targetStore) 
	throws FailException {
		...
		return new OrBoolVectorCloneable (list2, result2);
	}
