 ...
 */
public class DiffnCloneable extends Diffn implements ConstraintCloneableInterface<DiffnCloneable> {
     ...
     */
	public DiffnCloneable(IntVarCloneable[][] rectangles) {
		super(rectangles);
	}
     ...
     */
	public DiffnCloneable(IntVarCloneable[][] rectangles, boolean strict) {
     ...
     */
	public DiffnCloneable(IntVarCloneable[] origin1, IntVarCloneable[] origin2, IntVarCloneable[] length1, IntVarCloneable[] length2) {
     ...
     * @param strict  true- zero size rectangles need to be between other rectangles; false- these rectangles can be anywhere
     */
	public DiffnCloneable(IntVarCloneable[] origin1, IntVarCloneable[] origin2, IntVarCloneable[] length1, IntVarCloneable[] length2, boolean strict) {
     ...
     * @param rectangles list of rectangles which can not overlap in at least one dimension.
     */
	public DiffnCloneable(List<? extends List<? extends IntVarCloneable>> rectangles) {
		super(rectangles);
	}
     ...
     * @param strict     true- zero size rectangles need to be between other rectangles; false- these rectangles can be anywhere
     */
	public DiffnCloneable(List<? extends List<? extends IntVarCloneable>> rectangles, boolean strict) {
		super(rectangles, strict);
	}
     ...
     */
	public DiffnCloneable(List<? extends IntVarCloneable> o1, List<? extends IntVarCloneable> o2, List<? extends IntVarCloneable> l1,
	...
	@Override
	public DiffnCloneable cloneInto(StoreCloneable targetStore) throws CloneNotSupportedException, FailException {
		...
		return new DiffnCloneable (rectangles2, super.strict);
	}
