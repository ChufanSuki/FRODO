 ...
 */
public class SumBoolCloneable extends SumBool implements ConstraintCloneableInterface<SumBoolCloneable> {
	 ...
	 */
	public SumBoolCloneable(IntVarCloneable[] list, String rel, IntVarCloneable sum) {
		super(list, rel, sum);
	}
	 ...
	 * @param sum 		the total sum variable
	 */
	public SumBoolCloneable(ArrayList<? extends IntVarCloneable> list, String rel, IntVarCloneable sum) {
		super(list, rel, sum);
	}

	/** @see org.jacop.constraints.ConstraintCloneableInterface#cloneInto(StoreCloneable) */
	@Override
	public SumBoolCloneable cloneInto(StoreCloneable targetStore) 
		...
		return new SumBoolCloneable (x2, this.rel2String(), sum2);
	}
