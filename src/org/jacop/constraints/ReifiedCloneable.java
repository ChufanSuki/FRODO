...
/** A cloneable version of the Reified constraint
 * @author Thomas Leaute
 */
public class ReifiedCloneable extends Reified implements ConstraintCloneableInterface<PrimitiveConstraint> {

	/** Constructor
	 * @param c 	the constraint
	 * @param v 	the variable
	 */
	public ReifiedCloneable(PrimitiveConstraint c, IntVarCloneable v) {
		super(c, v);
	}
	...
	public PrimitiveConstraint cloneInto(StoreCloneable targetStore) 
		...
		return new ReifiedCloneable (clone, b2);
	}
