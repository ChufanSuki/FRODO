 ...
 */
public class CumulativeBasicCloneable extends CumulativeBasic implements ConstraintCloneableInterface<CumulativeBasicCloneable> {
   ...
   /**
     ...
     */
	public CumulativeBasicCloneable(IntVarCloneable[] starts, IntVarCloneable[] durations, IntVarCloneable[] resources, IntVarCloneable limit) {
     ...
     * @param limit     the overall limit of resources which has to be used.
     */
	public CumulativeBasicCloneable(List<? extends IntVarCloneable> starts, List<? extends IntVarCloneable> durations,
	...
	@Override
	public CumulativeBasicCloneable cloneInto(StoreCloneable targetStore) 
	throws FailException {
		...
		return new CumulativeBasicCloneable (starts2, durations2, resources2, limit2);
	}
