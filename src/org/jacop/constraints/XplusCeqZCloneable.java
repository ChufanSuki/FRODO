 ...
 */
public class XplusCeqZCloneable extends XplusCeqZ implements ConstraintCloneableInterface<XplusCeqZCloneable> {
	 ...
	 */
	public XplusCeqZCloneable(IntVarCloneable x, int c, IntVarCloneable z) {
		super(x, c, z);
	}

	/** @see ConstraintCloneableInterface#cloneInto(StoreCloneable) */
	@Override
	public XplusCeqZCloneable cloneInto(StoreCloneable targetStore) 
	throws FailException {
		...
		return new XplusCeqZCloneable (x2, this.c, z2);
	}
