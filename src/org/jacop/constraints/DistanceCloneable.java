 ...
 */
public class DistanceCloneable extends Distance implements ConstraintCloneableInterface<DistanceCloneable> {
	 ...
	 */
	public DistanceCloneable(IntVarCloneable x, IntVarCloneable y, IntVarCloneable z) {
		super(x, y, z);
	}

	/** @see ConstraintCloneableInterface#cloneInto(StoreCloneable) */
	@Override
	public DistanceCloneable cloneInto(StoreCloneable targetStore) 
	throws FailException {
		...
		return new DistanceCloneable (x2, y2, z2);
	}
