 ...
 */
public class AtMostCloneable extends AtMost implements ConstraintCloneableInterface<AtMostCloneable> {
     ...
     */
	public AtMostCloneable(IntVarCloneable[] list, int counter, int value) {
     ...
     * @param counter number of variables equal to val.
     */
	public AtMostCloneable(List<? extends IntVarCloneable> list, int counter, int value) {
		super(list, counter, value);
	}

	/** @see org.jacop.constraints.ConstraintCloneableInterface#cloneInto(org.jacop.core.StoreCloneable) */
	@Override
	public AtMostCloneable cloneInto(StoreCloneable targetStore) throws FailException {
		...
		return new AtMostCloneable (list2, this.counter, this.value);
	}
