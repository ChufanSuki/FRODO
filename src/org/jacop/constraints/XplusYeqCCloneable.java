 ...
 */
public class XplusYeqCCloneable extends XplusYeqC implements ConstraintCloneableInterface<XplusYeqCCloneable> {
	 ...
	 */
	public XplusYeqCCloneable(IntVarCloneable x, IntVarCloneable y, int c) {
		super(x, y, c);
	}

	/** @see ConstraintCloneableInterface#cloneInto(StoreCloneable) */
	@Override
	public XplusYeqCCloneable cloneInto(StoreCloneable targetStore) 
	throws FailException {
		...
		return new XplusYeqCCloneable (x2, y2, this.c);
	}
