...
/** A cloneable version of the OrBoolSimple constraint
 * @author Thomas Leaute
 */
public class OrBoolSimpleCloneable extends OrBoolSimple implements ConstraintCloneableInterface<OrBoolSimpleCloneable> {
	 ...
	 */
	public OrBoolSimpleCloneable(IntVarCloneable a, IntVarCloneable b, IntVarCloneable result) {
		super(a, b, result);
	}

	/** @see ConstraintCloneableInterface#cloneInto(StoreCloneable) */
	@Override
	public OrBoolSimpleCloneable cloneInto(StoreCloneable targetStore) 
	throws FailException {
		...
		return new OrBoolSimpleCloneable (a2, b2, result2);
	}
